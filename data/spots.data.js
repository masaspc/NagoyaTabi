...
(function (w) {
  ...
  NT.spots = [
    ...
    { id:'pokecen', name:'ポケモンセンターナゴヤ', area:'栄・大須', category:'ショッピング',
      ...
      trivia:[
        '名古屋PARCO東館2階にある',
        'しゃちほこピカチュウなど名古屋限定グッズを扱う',
        '祝日の昼過ぎは入場制限（整理券配布）が出ることがある'
      ],
      tips:[
    ...
    { id:'osu', name:'大須商店街', area:'栄・大須', category:'商店街',
      ...
      trivia:[
        ...
        '1200店舗超がひしめき、電気街・古着・食べ歩きが混在する独特のエリア',
        '全蓋アーケードの通りが多く、雨天や猛暑でも歩きやすい'
      ],
      tips:[
    ...
    { id:'shachihoko-shokudo', name:'鯱食堂', area:'名古屋城', category:'屋台・グルメ',
      ...
      official:'https://www.nagoyajo.city.nagoya.jp/',
      trivia:[
        '名古屋城夏まつり期間中に城内に出る飲食ブース',
        'かき氷やビール、屋台グルメを城内で楽しめる',
        '外の金シャチ横丁まで出なくても食事が完結する'
      ],
      tips:[
