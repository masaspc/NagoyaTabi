      ...
      days:[
        ...
        { date:'2026-08-12', label:'DAY 2 — 8/12 wed', items:[
          ...
          /* 8/11に行けなかったポケモンセンターを2日目の午前に回した（徳川美術館は取りやめ）。
             現地で判明: 整理券の配布は開店(10:00)ではなく9:00から。10:00に着いても
             その場では入れない。実際に9時台に並んで10:15の回を確保したので、
             入場時刻をその実績に合わせてある（変更履歴は data/changelog.data.js） */
          { time:'09:00', title:'ポケモンセンターの整理券を取る', spotId:'pokecen', kind:'plain',
            note:'整理券の配布は9:00から（開店の1時間前）。名古屋→栄（東山線）→矢場町（名城線）で乗換込み15分、' +
                 '矢場町駅4番出口から徒歩1分、名古屋PARCO東館2F（西館ではない）。' +
                 '整理券に書かれた回の時刻に戻る',
            stay:30, minStay:15 },
          { time:'09:30', title:'整理券の回まで待つ', kind:'plain',
            note:'屋外で待たない。松坂屋・PARCOの館内（10:00開店）か、コンパル 大須本店（8:00から・徒歩10分）で涼んで待つ。' +
                 '荷物をまだ持っているなら、この時間に名古屋駅のロッカーへ入れて戻る手もある（往復30分。' +
                 '整理券の時刻に間に合わないと判断したら、松坂屋のロッカーに預けて身軽になるほうが確実）',
            stay:45, minStay:10 },
          { time:'10:15', title:'ポケモンセンターナゴヤ', spotId:'pokecen', kind:'poke',
            note:'整理券で確保した回。しゃちほこピカチュウ・名古屋めしピカチュウ・金のコイキング像はここ限定。' +
                 '何を買うかは「グッズ」ページに順位をつけてある。カゴを先に取って、レジの列に並ぶ時間も見込む',
            stay:65, minStay:35, hardDeadline:'11:40', deadlineWhy:'昼食と土産・乗車の時間を残す最終ライン',
            alts:{
    ...
    { id:'B',
      ...
      days:[
        ...
        { date:'2026-08-12', label:'DAY 2 — 8/12 wed', items:[
          ...
          { time:'10:15', title:'ポケモンセンターナゴヤ', spotId:'pokecen', kind:'poke',
            note:'整理券で確保した回。しゃちほこピカチュウ・名古屋めしピカチュウ・金のコイキング像はここ限定。' +
                 '何を買うかは「グッズ」ページに順位をつけてある。昼の矢場とんはPARCOから徒歩3分',
            stay:80, minStay:35, hardDeadline:'11:35', deadlineWhy:'矢場とんの昼食に間に合わせる最終ライン',
            alts:{
              crowd:{ title:'整理券が出ていたらPARCO館内で待つ', spotId:'pokecen',
                note:'混雑時は入場整理券が配られる。番号の時間まで同じPARCOか隣の松坂屋で時間を潰せば、動かずに済む' },
              rain:{ title:'そのままPARCOへ', spotId:'pokecen',
